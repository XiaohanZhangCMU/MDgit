...
void WIREFrame::makefibers()
{
  printf("make fiber of wire is called\n");
    ...
    INFO_Printf("make fibe 2\n");

    // This initialize a cell in the center
...
void WIREFrame::potential()
{
  ...
  // INFO_Printf("pos1::_SR[25] = %lf %lf %lf\n", _SR[25].x, _SR[25].y, _SR[25].z);
  // INFO_Printf("pos1::_F[25] = %lf %lf %lf\n", _F[25][0],  _F[25][1], _F[25][2]);
  // INFO_Printf("pos1::_SR[15] = %lf %lf %lf\n", _SR[15].x, _SR[15].y, _SR[15].z);
  // INFO_Printf("pos1::_F[15] = %lf %lf %lf\n", _F[15][0],  _F[15][1], _F[15][2]);
  // INFO_Printf("pos1::_EPOT = %lf\n", _EPOT);
  // INFO_Printf("pos1::viral= %lf, %lf, %lf\n", _VIRIAL[0], _VIRIAL[1], _VIRIAL[2]);

  clvars();  LJBONDFrame::potential();
  accumvars(0); 

  INFO_Printf("pos2::_SR[25] = %lf %lf %lf\n", _SR[25].x, _SR[25].y, _SR[25].z);
  INFO_Printf("pos2::_F[25] = %lf %lf %lf\n", _F[25][0],  _F[25][1], _F[25][2]);
  INFO_Printf("pos2::_SR[15] = %lf %lf %lf\n", _SR[15].x, _SR[15].y, _SR[15].z);
  INFO_Printf("pos2::_F[15] = %lf %lf %lf\n", _F[15][0],  _F[15][1], _F[15][2]);
  INFO_Printf("pos2::_EPOT = %lf\n", _EPOT);
  INFO_Printf("pos2::viral= %lf, %lf, %lf\n", _VIRIAL[0], _VIRIAL[1], _VIRIAL[2]);

  clvars();  FEMFrame::fem_energy_force(); accumvars(1);

  INFO_Printf("pos3::_SR[25] = %lf %lf %lf\n", _SR[25].x, _SR[25].y, _SR[25].z);
  INFO_Printf("pos3::_F[25] = %lf %lf %lf\n", _F[25][0],  _F[25][1], _F[25][2]);
  INFO_Printf("pos3::_SR[15] = %lf %lf %lf\n", _SR[15].x, _SR[15].y, _SR[15].z);
  INFO_Printf("pos3::_F[15] = %lf %lf %lf\n", _F[15][0],  _F[15][1], _F[15][2]);
  INFO_Printf("pos3::_EPOT = %lf\n", _EPOT);
  INFO_Printf("pos3::viral= %lf, %lf, %lf\n", _VIRIAL[0], _VIRIAL[1], _VIRIAL[2]);
  ...
  INFO_Printf("pos4::_SR[25] = %lf %lf %lf\n", _SR[25].x, _SR[25].y, _SR[25].z);
  INFO_Printf("pos4::_F[25] = %lf %lf %lf\n", _F[25][0],  _F[25][1], _F[25][2]);
  INFO_Printf("pos4::_SR[15] = %lf %lf %lf\n", _SR[15].x, _SR[15].y, _SR[15].z);
  INFO_Printf("pos4::_F[15] = %lf %lf %lf\n", _F[15][0],  _F[15][1], _F[15][2]);
  INFO_Printf("pos4::_EPOT = %lf\n", _EPOT);
  INFO_Printf("pos4::viral= %lf, %lf, %lf\n", _VIRIAL[0], _VIRIAL[1], _VIRIAL[2]);
  }

  swapvars();

  INFO_Printf("pos5::_SR[25] = %lf %lf %lf\n", _SR[25].x, _SR[25].y, _SR[25].z);
  INFO_Printf("pos5::_F[25] = %lf %lf %lf\n", _F[25][0],  _F[25][1], _F[25][2]);
