...
public:
    ...
    double liquid_volume, com_x, com_y;
    ...
    PhaseFieldFrame(): _NX(100), _NY(100), _NZ(1), num_fields(1), model_type(0), gridsize(0), _F(0), _G(0), _Fraw(0),
                       ...
                       Fext_x(0.0), Fext_y(0.0), Penalty_3phase(0.5), Penalty_NW(0), stop_flag_x(0), stop_flag_y(0), com_x_obj(0), com_y_obj(0), stop_flag_solid(0), solid_obj(0), vol_incr0(0), x_incr0(0), y_incr0(0), liquid_volume(0), com_x(0), com_y(0), create_vapor(0), createfreq(100), shiftheight(0),
