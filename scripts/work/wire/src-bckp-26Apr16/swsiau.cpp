/*
  ...
  Last Modified : Thu Apr 22 16:41:46 2010
...
void SWFrame::initvars()
{
    ...
    /* Au potential */
       //aa_au=4.3277; bb_au=33.9191; plam_au=0;
       //pgam_au=0; acut_au=4.9311; pss_au=2.7395; 
       //aa_au=6.6858; bb_au=32.2313; plam_au=0;
       //pgam_au=0; acut_au=4.2889; pss_au=2.3827; 

       aa_au=6.5698; bb_au=32.0007; plam_au=0;
       pgam_au=0; acut_au=4.3028; pss_au=2.3905; 
...
#define NNM 60
	...
	if(species[ipt]==0)
	  ...
	  plam_i=plam_au;
	    ...
	    {
	      pgam=pgam_au; pss=pss_au; acut_sp = acut_au;
	    }
	    else 
	    {
	      pgam=(pgam_au+pgam_si)/2; pss=(pss_au+pss_si)/2;
	      acut_sp = (acut_si+acut_au)/2;
	    }
...
//            if(ipt>jpt) continue;
	    ...
	    {
	      aa=aa_au; bb=bb_au; pss=pss_au;
	    }
	    else 
	    {
	      aa=(aa_au+aa_si)/2; bb=(bb_au+bb_si)/2; pss=(pss_au+pss_si)/2; 
	    }
            au=aa*xpon2[j];
