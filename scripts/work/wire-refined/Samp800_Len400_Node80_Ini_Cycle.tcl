...
MD++ setnolog
MD++ setoverwrite
MD++ dirname = runs/wire-refined/Samp800_Len400_Node80_Ini_Cycle_${nfiber}_${ncase}
# density pref
...
MD++ incnfile = "../../../scripts/work/wire-refined/membrane2d-8x5element.cn" read2cn
MD++ map23 = \[ 0 2 \]
MD++ fem_coeff_file = "../../../scripts/work/wire-refined/membrane2d-8x5element-CPE4-Q4.dat"  read_fem_coeff
MD++ elements_file = "../../../scripts/work/wire-refined/membrane2d-8x5element.ele"  read_elements
MD++ fem_bdy_nodes_file = "../../../scripts/work/wire-refined/membrane2d-8x5element.bdy" read_bdy_nodes
