...
exec cp /home/xzhang11/Planet/Runs/Nucleation/MD++Run/21June16_Cu_Bulk/runs/w-disl-nuc-hetero-0/w-loop-compression-112-eps${eps}.cn ./NEBfinal.cn

#if { $eps <= 0.12 } {
#exec cp ../../../../scripts/work/PNAShomo/NEB/w-loop-compression-surf111-eps0.0900.cn NEBfinal.cn
#  exec cp ../../../../scripts/work/PNAShomo/NEB/NEBfinal.cn .
#} else {
#  exec cp ../../../../scripts/work/PNAShomo/NEB/NEBfinal1.cn NEBfinal.cn
#exec cp ../../../../scripts/work/PNAShomo/NEB/w-loop-compression-surf111-eps0.1200.cn NEBfinal.cn
#}
