...
exec cp ../../../../scripts/work/Us-Si-homo/NEB/NEBinit.cn .

if { $eps <= 0.12 } {
  exec cp ../../../../scripts/work/Us-Si-homo/NEB/NEBfinal.cn .
} else {
  exec cp ../../../../scripts/work/Us-Si-homo/NEB/NEBfinal1.cn NEBfinal.cn
}
