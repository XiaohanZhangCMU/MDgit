...
MD++ dirname = runs/ho-si-DN/${T}K_${epVAL}eps_112
...
latticesize = [  1  1  0  12
                -1  1  0  12
                 0  0  1  16 ]
makecn finalcnfile = si-DN-0.cn writecn
#-------------------------------------------------------------
#Plot Configuration
...
#MD++ ensemble_type="NPT" integrator_type="Gear6"
#MD++ ensemble_type="NVT" integrator_type="VVerlet"
...
MD++ ensemble_type="NVTC" totalsteps = 1000
MD++ writeall = 1 
MD++ initvelocity
