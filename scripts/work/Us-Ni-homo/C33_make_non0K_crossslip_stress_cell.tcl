...
MD++ dirname = runs/ho-Ni-DN/${T}K_${epVAL}eps_crossslip_112_33
...
set H21_0 [ MD++_Get H_21 ]
set H13_0 [ MD++_Get H_13 ]
set H31_0 [ MD++_Get H_31 ]
...
MD++ incnfile = "../${T}K_${epVAL}eps_crossslip_112/inter38.cn" readcn
...
MD++ conj_fixboxvec = \[ 1 1 1  1 1 1  1 1 1 \]
