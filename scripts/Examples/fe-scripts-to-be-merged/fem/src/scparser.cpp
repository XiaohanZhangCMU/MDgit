...
class TestParser: public SCParser
{
    double a;
    int I;
    long L;
...
public:
    ...
    {
        initparser();
        a=39.4; I=100; L=332124345;
        strcpy(s,"Now, our feature presentation!");
    }
    ...
    void help()
    {
        INFO("available commands: help printall quit");
        INFO("available variables: double a; int I; long L; char s[100];");       
    }
    void quit()
    {
        INFO("Bye-bye");
...
class TestParser testp;

int main(int argc, char *argv[])
{
    testp.initvars();
    testp.parse(SCParser::getfilehandler(argc,argv));
    return 0;
}
#endif
