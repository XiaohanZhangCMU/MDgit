...
//    bindvar("boxTcpl",&_BOXTCPL,DOUBLE);
    ...
    bindvar("energythreshold",energythreshold,DOUBLE);
    ...
    */
    ...
    bindvar("UMB_K_in_Kelvin",&UMB_K_in_Kelvin,DOUBLE);
...
int MDFrame::exec(const char *name)
{
    ...
    bindcommand_sync(name,"wrapper_run",wrapper_run());    
    ...
    bindcommand_sync(name,"potential_energyonly_iatom",potential_energyonly((int)input[0]));
    ...
    bindcommand(name,"assignUMBindexref",assignUMBindexref());
#ifdef _GSL
    ...
    bindcommand(name,"commit_removeatoms",commit_removeatoms());
    ...
    bindcommand(name,"SR1toSR",SR1toSR());    
    bindcommand(name,"SR1toSR_by_group",SR1toSR_by_group(input));    
    bindcommand(name,"SR2toSR_by_group",SR2toSR_by_group(input));    
    ...
    bindcommand(name,"writeRchain_parallel_fromCN",writeRchain_parallel_fromCN(input[0]));
...
int MDFrame::MCstep_moveatom()
{
    ...
    {/* randomly select trial atom */
        ...
        INFO_Printf("\n\n\n E1-E0 = %20.12e   Eatom1-Eatom0 = %20.12e  diff=%20.12e  EPOT0 = %20.12e\n",
                    E1-E0, Eatom1-Eatom0, (E1-E0)-(Eatom1-Eatom0) , _EPOT0);
        INFO_Printf("E1 = %20.12e   _EPOT1=%20.12e   diff=%20.12e   E0 = %20.12e\n",
                    E1, _EPOT0+Eatom1-Eatom0 , E1-(_EPOT0+Eatom1-Eatom0) , E0);
   	INFO_Printf("Epot0 - E0 = %20.12e\n", _EPOT0-E0);
    ...
    {
#ifdef _DEBUG_MC_ENERGY
	INFO_Printf("in MC_accept: _EPOT = %20.12e, _EPOT0 = %20.12e\n", _EPOT, _EPOT0);
	if (fabs(_EPOT0-E0)>1e-4) FATAL("_EPOT0 not equal to E0\n");
#endif
        _EPOT0=_EPOT;
        MC_accept_tot++;
    ...
    {
#ifdef _DEBUG_MC_ENERGY
	INFO_Printf("in MC_reject: _EPOT = %20.12e, _EPOT0 = %20.12e\n\n\n", _EPOT, _EPOT0);
	if (fabs(_EPOT0-E0)>1e-4) FATAL("_EPOT0 not equal to E0\n");
#endif
        if(MC_atom>=0)
        {
...
void MDFrame::MC_Update()
{
 /* virtual function to be re-implemented by child class for faster speed */
    ...
    /* for debugging purposes, not really needed for MC simulation*/
    if(MC_atom>=0) _SR_MC_SAV[MC_atom] = _SR[MC_atom];

    /* This block is not necessary.  It was creating problems for sw.cpp. */
    //int i,ipt; 
    ...
    /* This is not really needed here.  But it should not create problem */
...
void MDFrame::MC_Recover()
{
 ...
 /* virtual function to be re-implemented by child class for faster speed */
    /* for debugging purposes, not really needed for MC simulation*/
    if(MC_atom>=0) _SR[MC_atom] = _SR_MC_SAV[MC_atom];
...
void MDFrame::MC_UMBprocess()
{
	...
	umb_temp=(react_coord-react_coord_old)*(react_coord+react_coord_old-2*n_center);
        ...
        /* Note: changed again to remove KB    */
        ...
        if (acc_UMB) 
	{
	    ...
	    umb_Prob=exp(0.5*UMB_K_in_Kelvin*pow((react_coord-n_center),2)/(_TDES));

            //INFO_Printf(" react_coord = %g  bias potential/kBT = %g\n", react_coord,
	    //            (0.5*UMB_K_in_Kelvin*pow((react_coord-n_center),2)/(_TDES)));
	...
	else
	{
	    ...
	    umb_Prob=exp(0.5*UMB_K_in_Kelvin*pow((react_coord_old-n_center),2)/(_TDES));

            //INFO_Printf(" react_coord_old = %g  bias potential/kBT = %g\n", react_coord_old,
	    //            (0.5*UMB_K_in_Kelvin*pow((react_coord_old-n_center),2)/(_TDES)));
