...
void FEMFrame::cuda_snap_fem_energy_force() {
 ...
 kernel_assemble_back_force<<<(_NP+255)/256,256>>>(_NP, _d_fixed, _d_inv_elements, _d_F, _d_F_padding);
