...
/* Need to Fix!! remove malloc in md.h */

/* initialize md++ class */
extern "C" void md_init(char **name)
{
    sim.initvars();
    strcpy(sim.myname,*name);
    Rprintf("sim.myname = %s\n",sim.myname);
}

/* execute MD++ commands */
extern "C" void md_cmd(char **cmd)
{
    FILE *istream, *ostream; int mypipe[2];                          
...
/* get MD++ variable values */
extern "C" void md_get(char **name)
{                       
    Rprintf ("md_get not implemented yet.\n");                          
    return;                                         
}

extern "C" void md_get_array(char **name, int *n, int *index)
{                       
    Rprintf ("md_get_array not implemented yet.\n");                          
    return;
}

extern "C" void md_set_array(char **name, int *n, int *index, double *v)
{                       
    Rprintf ("md_set_array not implemented yet.\n");                          
    return;
}
