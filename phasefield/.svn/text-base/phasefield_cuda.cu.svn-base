...
com_x0 = thrust::inner_product(t_matrix_x, t_matrix_x+_NX*_NY*_NZ, t_CPHI, 0.0);
com_x0 /= liquid_volume;
com_y0 = thrust::inner_product(t_matrix_y, t_matrix_y+_NX*_NY*_NZ, t_CPHI, 0.0);
com_y0 /= liquid_volume;
...
else if (dynamics_type == 7)
{
    ...
    /* modify the code to fix the failure of the contriant of COM when liquid volume is not a constant */    
    A_31 = A_31 - com_x0*A_11;
    A_32 = A_32 - com_x0*A_12;
    A_33 = A_33 - com_x0*A_13;  
    A_34 = A_34 - com_x0*A_14;
    A_41 = A_41 - com_y0*A_11;
    A_42 = A_42 - com_y0*A_12;
    A_43 = A_43 - com_y0*A_13;
    A_44 = A_44 - com_y0*A_14;
...
else if (dynamics_type == 10)
{
    if ( com_y_incr - y_incr0 >= 0.0 )
   /* force the NW to grow along certain path */
    {
